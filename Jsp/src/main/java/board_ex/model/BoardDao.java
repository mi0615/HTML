...
public class BoardDao
{
	...
	private static final String		dbUser		=	"mint";
	private static final String		dbPass		=	"mint";
...
private Connection	 		con;	
	...
	*/
	public int insert( BoardVO rec ) throws BoardException
	{
		...
		try{
			...
			//* sql 문장 만들기
			String putQuery	= "insert into board_ex(seq, title, writer, content, regdate, cnt, pass) values(board_seq.nextval, ?, ?, ?, sysdate, ?, ?)";  
	...
	*/
	...
	public int getSequence() throws BoardException{
		PreparedStatement ps = null;
		ResultSet rs = null;
		try{
